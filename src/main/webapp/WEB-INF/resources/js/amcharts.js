if (!AmCharts)
    var AmCharts = {themes: {}, maps: {}, inheriting: {}, charts: [], onReadyArray: [], useUTC: !1, updateRate: 40, uid: 0, lang: {}, translations: {}, mapTranslations: {}, windows: {}, initHandlers: []};
...
if (document.addEventListener || window.opera)
    AmCharts.isNN = !0, AmCharts.isIE = !1, AmCharts.dx = .5, AmCharts.dy = .5;
...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            l.remove();
            for (var l = [], p = 0; - 1 < (index = b.indexOf(" ", p)); )
                l.push(index), p = index + 1;
            Math.round(b.length / 2);
            for (var r, p = 0; p < l.length; p += Math.ceil(l.length / n))
                r = l[p], b = b.substr(0, r) + m + b.substr(r + 1);
            if (isNaN(r)) {
                if (0 == k)
                    for (p = 1; p < n; p++)
                        r = Math.round(b.length / n * p), b = b.substr(0, r) + m + b.substr(r);
...
AmCharts.extend = function (a, b, c) {
    for (var d in b)
        c ? a.hasOwnProperty(d) || (a[d] = b[d]) : a[d] = b[d];
    return a
};
...
AmCharts.AxisBase = AmCharts.Class({construct: function (a) {
        ...
        var a = this.position;
        "H" == this.orientation ? ("left" ==
                a && (a = "bottom"), "right" == a && (a = "top")) : ("bottom" == a && (a = "left"), "top" == a && (a = "right"));
        this.position = a
    }, draw: function () {
        var a = this.chart;
        this.allLabels = [];
        ...
        this.autoGridCount ? ("V" == this.orientation ? (a = this.height / this.minVerticalGap, 3 > a && (a = 3)) : a = this.width / this.minHorizontalGap, this.gridCountR =
        ...
        if (a) {
            ...
            switch (this.position) {
                ...
                case "right":
                    b =
                            d + g + 10 + m - 3, n && (b += 7), c = "left" == p ? k + 2 : "right" == p ? -2 : k / 2, l = -90
            }
        ...
        if (d = a.getLabel())
            this.labelsSet.push(d), d.click(function (b) {
    ...
    handleMouse: function (a, b, c) {
        ...
        for (var b = this.guides, c = !1, d = b.length, e = 0; e < b.length; e++)
            b[e] == a && (c = !0, d = e);
        ...
        var b = a.graphics.getBBox(), c = b.x + b.width /
                2, b = b.y + b.height / 2, d = a.fillColor;
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) ||
                !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
            c = !0;
        else {
            var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, n = 1, p = 0, r = Math.round((this.max - this.min) / this.step) + 1, q;
            !0 === d ? (q = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / q, q > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCountR && (n = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth /
                    (this.max - this.min);
            var u = 0;
            ...
            if (0 < e) {
                ...
                for (f = this.fillAlpha =
                        0; f < e; f++) {
                    var y = t[f], A = NaN, C = y.above;
            ...
            for (f = p; f <
                    r; f += n)
                t = AmCharts.roundTo(this.step * f + this.min, u), -1 != String(t).indexOf("e") && (this.exponential = !0, String(t).split("e"));
            this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
            var u = this.step, H, t = this.minorGridAlpha;
            ...
            for (f = p; f < r; f += n)
                if (p = u * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
                    if (isNaN(z) || Number(AmCharts.toFixed(p,
                            z)) == p) {
                        ...
                        if (p == this.baseValue && "radar" != a.type) {
                            var D, I, y = this.viW, C = this.viH;
                            x = this.viX;
                            w = this.viY;
                            "H" == this.orientation ? 0 <= e && e <= y + 1 && (D = [e, e, e + g], I = [C, 0, h]) : 0 <= e && e <= C + 1 && (D = [0, y, y + g], I = [e, e, e + h]);
                            D && (e = AmCharts.fitToBounds(2 *
                                    this.gridAlpha, 0, 1), e = AmCharts.line(a.container, D, I, this.gridColor, e, 1, this.dashLength), e.translate(x, w), this.grid0 = e, a.axesSet.push(e), e.toBack(), AmCharts.setCN(a, e, this.bcn + "zero-grid-" + this.id), AmCharts.setCN(a, e, this.bcn + "zero-grid"))
                        }
                        if (!isNaN(H) && 0 < t && f < r - 1) {
                            x = this.gridAlpha;
                            this.gridAlpha = this.minorGridAlpha;
                            for (e = 1; e < u / H; e++)
                                w = this.getCoordinate(p + H * e), w = new this.axisItemRenderer(this, w, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(w);
                            this.gridAlpha = x
                        }
                    }
            q = this.baseValue;
            this.min > this.baseValue &&
                    this.max > this.baseValue && (q = this.min);
            ...
            q = {type: "axisChanged", target: this, chart: a};
        ...
        !this.visible || c ? (b.hide(), d.hide(), q.hide()) : (b.show(),
                d.show(), q.show());
        ...
        d ? (b = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), c = b.split("e"), b = Number(c[0]), c = Number(c[1]), b = AmCharts.roundTo(b, 14), 10 == b && (b = 1, c += 1), b = b + "e" + c, 0 === a && (b = "0"), 1 == a && (b = "1")) : (e && (d = String(a).split("."),
                d[1] ? (f.precision = d[1].length, 0 > c && (f.precision = Math.abs(c))) : f.precision = -1), b = this.usePrefixes ? AmCharts.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : AmCharts.formatNumber(a, f, f.precision));
        ...
        "100% stacked" == b && (b = "100%");
        this.stackType = b;
        var c = [], d = [], e = [], f = [], g, h = this.chart.graphs, k, l, m, n, p = this.baseValue, r = !1;
        if ("line" == a || "step" == a || "smoothedLine" == a)
            r = !0;
        if (r && ("regular" == b || "100%" == b))
            for (n = 0; n < h.length; n++)
                m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (k && (m.stackGraph = k), k = m));
        for (k = this.start; k <= this.end; k++) {
            var q = 0;
            for (n = 0; n < h.length; n++)
                if (m = h[n], m.hidden)
                    m.newStack && (e[k] = NaN, d[k] = NaN);
                else if (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable)
                    if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g))
                        m.newStack && (e[k] = NaN, d[k] =
                                NaN);
                    else {
                        ...
                        "regular" == b && (r && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" == a && (m.newStack && (e[k] = NaN, d[k] = NaN), l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ?
                                l.values.open = p : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) : (l.values.close = g, isNaN(e[k]) ? l.values.open = p : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)))
                    }
        }
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)
                (m = h[n], m.hidden) ? m.newStack && (e[k] = NaN, d[k] = NaN) : (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = g / f[k] * 100, l.values.percents = c, l.values.total = f[k], m.newStack &&
                        (e[k] = NaN, d[k] = NaN), "100%" == b && (isNaN(d[k]) && (d[k] = 0), isNaN(e[k]) && (e[k] = 0), 0 > c ? (l.values.close = AmCharts.fitToBounds(c + d[k], -100, 100), l.values.open = d[k], d[k] = l.values.close) : (l.values.close = AmCharts.fitToBounds(c + e[k], -100, 100), l.values.open = e[k], e[k] = l.values.close)))))
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                if ("candlestick" == d.type || "ohlc" == d.type)
                    e = "open";
                var f, g, h = this.end + 2, h = AmCharts.fitToBounds(this.end + 1,
                        0, this.data.length - 1), k = this.start;
                0 < k && k--;
                var l;
                g = this.start;
                d.compareFromStart && (g = 0);
                if (!isNaN(a.startTime) && (l = a.categoryAxis)) {
                    var m = l.minDuration(), m = new Date(a.startTime + m / 2), n = AmCharts.resetDateToMin(new Date(a.startTime), l.minPeriod).getTime();
                    AmCharts.resetDateToMin(new Date(m), l.minPeriod).getTime() > n && g++
                }
                if (l = a.recalculateFromDate)
                    a.dataDateFormat && (l = AmCharts.stringToDate(l, a.dataDateFormat)), g = a.getClosestIndex(a.chartData, "time", l.getTime(), !0, 0, a.chartData.length), h = a.chartData.length -
                            1;
                ...
                for (e = k; e <= h; e++) {
                    ...
                    var k = g.values, p;
                    for (p in k)
                        g.percents[p] = "percents" != p ? k[p] / f * 100 - 100 : k[p]
                }
            }
        }
    }, getMinMax: function () {
        ...
        "serial" ==
                b.type && (!0 !== b.categoryAxis.parseDates || a || this.end < this.data.length - 1 && this.end++);
        ...
        b = this.max;
        c = this.max - this.min;
        d = 0 === c ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max)) * Math.LOG10E)) / 10 : Math.pow(10, Math.floor(Math.log(Math.abs(c)) * Math.LOG10E)) /
                10;
        ...
        0 > this.min && 0 <= a && (this.min = 0);
        0 < this.max && 0 >= b && (this.max = 0);
        1 < this.minReal && 1 < this.max - this.minReal &&
        ...
        this.logarithmic && (2 < c ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) *
                Math.LOG10E))) : (b = Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10, a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, b < a && (this.minReal = this.min = 10 * a)))
    }, getMin: function (a, b) {
        var c, d;
        for (d = a; d <= b; d++) {
                ...
                if (e.hasOwnProperty(f)) {
                    ...
                    if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                        ...
                        if (this.minMaxField)
                            ...
                            for (var k in g)
                                g.hasOwnProperty(k) && "percents" != k && "total" != k && (h = g[k], h < c && (c = h))
                    }
                }
        }
        return c
        ...
        this.listenTo(this.synchronizeWith, "axisChanged",
...
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l, m, n) {
        b = Math.round(b);
        var p = a.chart;
        this.value = c;
        void 0 == c && (c = "");
        k || (k = 0);
        void 0 == d && (d = !0);
        var r = p.fontFamily, q = a.fontSize;
        ...
        this.set = x;
        var t = a.axisThickness, w = a.axisColor, y = a.axisAlpha, A = a.tickLength, C = a.gridAlpha, B = a.gridThickness, H = a.gridColor, D = a.dashLength, I = a.fillColor, X = a.fillAlpha, ca = a.labelsEnabled;
        m = a.labelRotation;
        var oa = a.counter, S = a.inside, ma = a.labelOffset, pa = a.dx, ia = a.dy, Oa = a.orientation, Z = a.position, Y = a.previousCoord, T = a.viH, ra = a.viW, aa = a.offset, ba, sa;
        g ? (void 0 != g.id && (n = p.classNamePrefix + "-guide-" + g.id), ca = !0, isNaN(g.tickLength) || (A = g.tickLength), void 0 != g.lineColor && (H = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (C = g.lineAlpha), isNaN(g.dashLength) || (D = g.dashLength), isNaN(g.lineThickness) || (B = g.lineThickness), !0 === g.inside && (S = !0), isNaN(g.labelRotation) || (m = g.labelRotation), isNaN(g.fontSize) ||
                (q = g.fontSize), g.position && (Z = g.position), void 0 !== g.boldLabel && (h = g.boldLabel), isNaN(g.labelOffset) || (ma = g.labelOffset)) : "" === c && (A = 0);
        var ha = "start";
        e && (ha = "middle");
        var O = m * Math.PI / 180, U, va, G = 0, v = 0, ja = 0, da = U = 0, Pa = 0;
        "V" == Oa && (m = 0);
        var W;
        ...
        if ("H" == Oa) {
            if (0 <= b && b <= ra + 1 && (0 < A && 0 < y && b + k <= ra + 1 && (ba = AmCharts.line(z, [b + k, b + k], [0, A], w, y, B), x.push(ba)), 0 < C && (sa = AmCharts.line(z,
                    ...
                    4) : v -= A + q + 3 + 3, v -= ma) : (0 < m ? (v = T + da / 2 * Math.sin(O) + A + 3, G -= da / 2 * Math.cos(O)) : 0 > m ? (v = T + A + 3 - da / 2 * Math.sin(O) + 2, G += da / 2 * Math.cos(O)) : v += A + t + 3 + 3, v += ma)) : (v += ia + q / 2 - aa, G += pa, S ? (0 < m ? (v = da / 2 * Math.sin(O) + A + 3, G -= da / 2 * Math.cos(O)) : v += A + 3, v += ma) : (0 < m ? (v = -(da / 2) * Math.sin(O) - A - 6, G += da / 2 * Math.cos(O)) : v -= A + q + 3 + t + 3, v -= ma)), "bottom" == Z ? U = (S ? T - A - 1 : T + t - 1) + aa : (ja = pa, U = (S ? ia : ia - A - t + 1) - aa), f && (G += f), f = G, 0 < m && (f += da / 2 * Math.cos(O)), W && (q = 0, S && (q = da / 2 * Math.cos(O)), f + q > ra + 2 || 0 > f))
                W.remove(), W = null
        } else {
            0 <= b && b <= T + 1 && (0 < A && 0 < y &&
                    b + k <= T + 1 && (ba = AmCharts.line(z, [0, A], [b + k, b + k], w, y, B), x.push(ba)), 0 < C && (sa = AmCharts.line(z, [0, pa, ra + pa], [b, b + ia, b + ia], H, C, B, D), x.push(sa)));
            ha = "end";
            if (!0 === S && "left" == Z || !1 === S && "right" == Z)
                ha = "start";
            v = b - q / 2;
            ...
            v += q / 2;
            "right" == Z ? (G += pa + ra + aa, v += ia, S ? (f || (v -= q / 2 + 3), G = G - (A + 4) - ma) : (G += A + 4 + t, v -= 2, G += ma)) : S ? (G += A + 4 - aa, f || (v -=
                    q / 2 + 3), g && (G += pa, v += ia), G += ma) : (G += -A - t - 4 - 2 - aa, v -= 2, G -= ma);
        ...
        W && (W.attr({"text-anchor": ha}), W.translate(G, v), 0 !== m && W.rotate(-m, a.chart.backgroundColor), a.allLabels.push(W), this.label =
                W, AmCharts.setCN(p, W, a.bcn + "label"), AmCharts.setCN(p, W, n, !0), g && AmCharts.setCN(p, W, "guide"));
...
AmCharts.RecFill = AmCharts.Class({construct: function (a, b, c, d) {
        ...
        var l = d.fillAlpha;
        isNaN(l) && (l = 0);
        var k = a.chart.container, m = d.fillColor;
        ...
        "V" == g ? (g = AmCharts.rect(k, a.width, c, m, l), g.translate(e, b - h + f)) : (g = AmCharts.rect(k,
                c, a.height, m, l), g.translate(b - h + e, f));
...
AmCharts.AmChart = AmCharts.Class({construct: function (a) {
        ...
        this.prefixesOfSmallNumbers = [{number: 1E-24, prefix: "y"}, {number: 1E-21, prefix: "z"}, {number: 1E-18, prefix: "a"}, {number: 1E-15, prefix: "f"}, {number: 1E-12, prefix: "p"}, {number: 1E-9, prefix: "n"}, {number: 1E-6, prefix: "\u03bc"},
            {number: .001, prefix: "m"}];
        ...
        if (b = this.backgroundImage)
            this.path && (b = this.path + b), a = a.image(b, 0, 0, e, f), AmCharts.setCN(this, b, "bg-image"), this.bgImg = a, d.push(a)
    }, drawTitles: function () {
        var a = this.titles;
        ...
        this.mouseMode = a;
        (a = this.container) ? (a.container.innerHTML = "", this.chartDiv.appendChild(a.container), a.setSize(this.realWidth, this.realHeight)) : a = new AmCharts.AmDraw(this.chartDiv, this.realWidth,
        ...
        AmCharts.VML || AmCharts.SVG ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, this.container = a, this.set && this.set.remove(), this.set = a.set(), this.gridSet && this.gridSet.remove(), this.gridSet = a.set(), this.cursorLineSet && this.cursorLineSet.remove(), this.cursorLineSet = a.set(), this.graphsBehindSet && this.graphsBehindSet.remove(), this.graphsBehindSet = a.set(), this.bulletBehindSet && this.bulletBehindSet.remove(), this.bulletBehindSet =
                ...
                this.axesLabelsSet && this.axesLabelsSet.remove(), this.axesLabelsSet = a.set(), this.freeLabelsSet = a.set(), this.balloonsSet && this.balloonsSet.remove(), this.balloonsSet = a.set(), this.zoomButtonSet && this.zoomButtonSet.remove(), this.zoomButtonSet = a.set(), this.linkSet && this.linkSet.remove(), this.linkSet = a.set(), this.renderFix()) : this.fire("failed", {type: "failed", chart: this})
    }, measure: function () {
        var a = this.div;
        if (a) {
    ...
    updateWidth: function () {
        ...
        this.chartRendered || (a = "rendered", this.fire(a, {type: a,
            chart: this}), this.chartRendered = !0);
        a = "drawn";
    ...
    handleMouseOut: function (a) {
        ...
        for (a = this.animations.length - 1; 0 <= a; a--) {
            ...
            if (d <= c) {
                ...
                e.node.style[f] = Number(b.to) + b.suffix, this.animations.splice(a, 1)
        }
    }, inIframe: function () {
        try {
...
AmCharts.AmGraph = AmCharts.Class({construct: function (a) {
        ...
        AmCharts.ifArray(this.data) && (a = !1, "xy" == b ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = !0) : this.valueAxis.axisCreated && (a = !0), !this.hidden &&
                a && this.createGraph())
        ...
        for (e = this.start; e <= this.end; e++) {
            var f = this.data[e].axes[c.id].graphs[this.id],
                    g = f.values, h = g.x, k = g.y, g = c.getCoordinate(h), l = d.getCoordinate(k);
        ...
        e = "middle";
        f = !1;
        var g = this.labelPosition, h = c.getBBox(), k = d.graphDataItem, l = this.chart.rotate, m = k.isNegative;
        b -= h.height / 4 / 2;
        switch (g) {
            case "top":
        ...
        var n = k.columnGraphics, p = 0, r = 0;
        n && (p = n.x, r = n.y);
        ...
        isNaN(h) && (h = .8);
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, r = this.rotate, q = this.columnCount, u = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), z = this.connect, x = [], t = [], w, y, A, C, B = this.chart.graphs.length, H, D = this.dx / this.tcc, I = this.dy / this.tcc, X = f.stackType, ca = this.start, oa = this.end, S = this.scrollbar, ma = "graph-column-";
        S && (ma = "scrollbar-graph-column-");
        var pa = this.categoryAxis, ia = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, Y = this.lineThickness, T = this.lineAlpha,
                ra = this.lineColorR, aa = this.dashLength, ba = this.set, sa, ha = this.getGradRotation(), O = this.chart.columnSpacing, U = pa.cellWidth, va = (U * h - q) / q;
        O > va && (O = va);
        var G, v, ja, da = n + 1, Pa = m + 1, W = 0, pb = 0, qb, rb, db, eb, sb = this.fillColorsR, Ia = this.negativeFillColors, Ba = this.negativeLineColor, Va = this.fillAlphas, Wa = this.negativeFillAlphas;
        ...
        if (!(S || "line" != g && "smoothedLine" != g && "step" != g || (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ia && void 0 == Ba || l))) {
            ...
            var Fa = f.getCoordinate(Qa), Hb = f.getCoordinate(f.max);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == X || "100%" == X || this.fillToGraph)
                Ja = !0;
        var Jb = this.noStepRisers, gb = -1E3, hb = -1E3, ib = this.minDistance, Ka = !0, Xa = !1;
        for (J = ca; J <= oa; J++) {
            G = d[J];
            ...
            if (l && void 0 == this.openField)
                for (var tb = J + 1; tb < d.length && (!d[tb] || !(Ya = d[J + 1].axes[f.id].graphs[b]) || !Ya.values || (La = Ya.values.value, isNaN(La))); tb++)
                    ;
            var R, N, L, ea, ka = NaN, F = NaN, E = NaN, M = NaN, K = NaN,
                    Ma = NaN, Ca = NaN, Na = NaN, Da = NaN, xa = NaN, ya = NaN, fa = NaN, ga = NaN, V = NaN, ub = NaN, vb = NaN, la = NaN, na = void 0, Ha = sb, Ra = Va, za = ra, ta, wa, wb = this.proCandlesticks, jb = this.topRadius, Za = this.pattern;
            ...
            if (Aa) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    V = Aa.close, vb =
                            Aa.low, Ca = f.getCoordinate(vb), ub = Aa.high, Da = f.getCoordinate(ub);
                la = Aa.open;
                E = f.getCoordinate(V);
                ...
                var ka = G.x[pa.id], Sa = this.periodSpan - 1, qa = Math.floor(U / 2) + Math.floor(Sa * U / 2), Ea = qa, kb = 0;
                "left" == this.stepDirection &&
                        (kb = (2 * U + Sa * U) / 2, ka -= kb);
                ...
                if (!wb && V < la ||
                        wb && V < sa)
                    v.isNegative = !0, Ia && (Ha = Ia), Wa && (Ra = Wa), void 0 != Ba && (za = Ba);
                Xa = !1;
                isNaN(V) || (l ? V > La ? (Ka && (Xa = !0), Ka = !1) : (Ka || (Xa = !0), Ka = !0) : v.isNegative = V < Oa ? !0 : !1, sa = V);
                switch (g) {
                    case "line":
                        if (isNaN(V))
                            z || (this.drawLineGraph(x, t, P, Q), x = [], t = [], P = [], Q = []);
                        else {
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib)
                                x.push(F), t.push(E), gb = F, hb = E;
                            xa = F;
                            ya = E;
                            fa = F;
                            ga = E;
                            ...
                            if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength))
                                this.drawLineGraph(x, t, P, Q), x = [F], t =
                                        [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Ka ? (this.lineColorSwitched = ra, this.fillColorsSwitched = sb) : (this.lineColorSwitched = Ba, this.fillColorsSwitched = Ia) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
                            v.gap && (this.drawLineGraph(x, t, P, Q), x = [], t = [], P = [], Q = [])
                        }
                        break;
                    case "smoothedLine":
                        if (isNaN(V))
                            z || (this.drawSmoothedGraph(x, t, P, Q), x = [], t = [], P = [], Q = []);
                        else {
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib)
                                x.push(F), t.push(E),
                                        gb = F, hb = E;
                    ...
                    case "step":
                        if (!isNaN(V)) {
                            r ? (isNaN(w) || (x.push(w), t.push(E - qa)), t.push(E - qa), x.push(F),
                                    t.push(E + Ea), x.push(F), !Ja || isNaN(K) || isNaN(M) || (isNaN(A) || (P.push(A), Q.push(K - qa)), P.push(M), Q.push(K - qa), P.push(M), Q.push(K + Ea))) : (isNaN(y) || (t.push(y), x.push(w), t.push(y), x.push(F - qa)), x.push(F - qa), t.push(E), x.push(F + Ea), t.push(E), !Ja || isNaN(K) || isNaN(M) || (isNaN(C) || (P.push(M - qa), Q.push(C)), P.push(M - qa), Q.push(K), P.push(M + Ea), Q.push(K)));
                            w = F;
                            y = E;
                            A = M;
                            C = K;
                            ...
                            ga = E;
                            if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                                var Wb = x[x.length - 2], Xb = t[t.length - 2];
                                x.pop();
                                t.pop();
                            ...
                            if (Jb || v.gap)
                                w = y = NaN, this.drawLineGraph(x, t, P, Q), x = [], t = [], P = [], Q = []
                        } else if (!z) {
                            if (1 >= this.periodSpan || 1 < this.periodSpan && F - w > qa + Ea)
                                w = y = NaN;
                            this.drawLineGraph(x, t, P, Q);
                            x = [];
                            t = [];
                    ...
                    case "column":
                        ...
                        if (!isNaN(V)) {
                            ...
                            if (na && (wa = na.set, AmCharts.setCN(a, na.set, "graph-" + this.type), AmCharts.setCN(a, na.set, "graph-" + this.id), v.className && AmCharts.setCN(a, na.set, v.className, !0), v.columnGraphics = wa, wa.translate(R, N), this.columnsSet.push(wa), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), !S)) {
                                ...
                                "3d" == X && (r ? (H =
                                        (this.end + 1 - J) * B - c - 1E3 * this.depthCount, xa += D * this.columnIndex, fa += D * this.columnIndex, v.y += D * this.columnIndex) : (H = (B - c) * (J + 1) + 1E3 * this.depthCount, ya += I * this.columnIndex, ga += I * this.columnIndex, v.y += I * this.columnIndex));
                                if ("regular" == X || "100%" == X)
                                    H = r ? 0 < Aa.value ? (this.end + 1 - J) * B + c : (this.end + 1 - J) * B - c : 0 < Aa.value ? B * J + c : B * J - c;
                                this.columnsArray.push({column: na, depth: H});
                                v.x = r ? N + L / 2 : R + L / 2;
                    ...
                    case "candlestick":
                        if (!isNaN(la) &&
                            ...
                            if (r) {
                                ...
                                wb && V >= la && (Ra = 0);
                                var na = new AmCharts.Cuboid(e, L, ea,
                                        D, I, Ha, Ra, Y, ta, T, ha, u, r, aa, Za, jb, ma), Ab, Bb;
                            ...
                            na && (wa = na.set, v.columnGraphics = wa, ba.push(wa), wa.translate(R, N - Y / 2), (v.url || this.showHandOnHover) && wa.setAttr("cursor",
                    ...
                    case "ohlc":
                        if (!(isNaN(la) || isNaN(ub) || isNaN(vb) || isNaN(V))) {
                            ...
                            var lb, mb, nb;
                            if (r) {
                                var Cb = E - h / 2, Cb = AmCharts.fitToBounds(Cb, 0, n), Nb = AmCharts.fitToBounds(E, 0, n),
                                        Db = E + h / 2, Db = AmCharts.fitToBounds(Db, 0, n);
                                ...
                                var Eb = F - h / 2, Eb = AmCharts.fitToBounds(Eb, 0, m), Ob = AmCharts.fitToBounds(F, 0, m), Fb = F + h / 2, Fb = AmCharts.fitToBounds(Fb, 0, m);
                                mb = AmCharts.line(e, [Eb, Ob], [K, K], za, T, Y, aa);
                                0 < F && F < m && (lb = AmCharts.line(e, [F, F], [Ca, Da], za, T, Y, aa));
                                nb = AmCharts.line(e, [Ob, Fb], [E,
                                    E], za, T, Y, aa);
                                ga = E;
                                "open" == k && (ga = K);
                                "high" == k && (ga = Da);
                ...
                if (!S && !isNaN(V)) {
                    ...
                    if (this.end - this.start <= Pb || 0 === Pb) {
                        var $b = this.createBullet(v, fa, ga, J), Qb = this.labelText;
                        if (Qb) {
                            var Gb = this.createLabel(v, fa, ga, Qb);
                            (Gb = this.positionLabel(xa,
                                    ya, Gb, $b, L, ea)) && this.allBullets.push(Gb)
                        }
                        if ("regular" == X || "100%" == X) {
                            var Rb = f.totalText;
                            if (Rb) {
                                ...
                                var Sb = Ua.getBBox(), Tb = Sb.width, Ub = Sb.height, ab, bb, ob = f.totalTextOffset, Vb = f.totals[J];
                                Vb && Vb.remove();
                                var cb = 0;
        ...
        if ("line" ==
                g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(x, t, P, Q) : this.drawLineGraph(x, t, P, Q), S || this.launchAnimation();
        ...
        a.clipRect(this.nmx, this.nmy, this.nmw,
                this.nmh)
        ...
        if (1 < a.length) {
            ...
            f.push(l);
            f.push(k);
            var m = e.lineAlpha, n = e.lineThickness, f = e.fillAlphas, p = e.lineColorR, r = e.negativeLineAlpha;
            isNaN(r) && (r = m);
            var q = e.lineColorSwitched;
            q && (p = q);
            var q = e.fillColorsR, u = e.fillColorsSwitched;
            u && (q = u);
            var z = e.dashLength;
            (u = e.dashLengthSwitched) && (z = u);
            var u = e.negativeLineColor, x = e.negativeFillColors, t = e.negativeFillAlphas, w = e.baseCoord;
            ...
            if (0 < f || 0 < t)
                if (n = a.join(";").split(";"), r = b.join(";").split(";"), m = g.type,
                ...
                1]), n.push(w), r.push(r[0]), n.push(w), r.push(r[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(h, n, r, q, f, 1, "#000", 0, a), b.pattern(e.pattern), AmCharts.setCN(g, b, e.bcn + "fill"), k.push(b)), x || void 0 !== u)
                    isNaN(t) && (t = f), x || (x = u), h = AmCharts.polygon(h, n, r, x, t, 1, "#000", 0, a), AmCharts.setCN(g, h, e.bcn + "fill"), AmCharts.setCN(g, h, e.bcn + "fill-negative"), h.pattern(e.pattern), l.push(h), l.click(function (a) {
                        e.handleGraphEvent(a, "clickGraph")
                    }).mouseover(function (a) {
                        e.handleGraphEvent(a, "rollOverGraph")
                    }).mouseout(function (a) {
        ...
        if (1 < a.length) {
            var e = this.set, f = this.chart, g = this.container, h = g.set(), k = g.set();
            e.push(k);
            e.push(h);
            var l = this.lineAlpha, m = this.lineThickness, e = this.dashLength, n = this.fillAlphas, p = this.lineColorR, r = this.fillColorsR, q = this.negativeLineColor, u = this.negativeFillColors, z = this.negativeFillAlphas, x =
                    this.baseCoord, t = this.lineColorSwitched;
            t && (p = t);
            ...
            0 < n && (l = a.join(";").split(";"), p = b.join(";").split(";"), m = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), l = a.concat(c),
    ...
    launchAnimation: function () {
        ...
        b && (this.rotate ? (b.translate(-1E3,
                e), c.translate(-1E3, e)) : (b.translate(d, -1E3), c.translate(d, -1E3)), b.animate({opacity: 1, translate: d + "," + e}, f, a), c.animate({opacity: 1, translate: d + "," + e}, f, a))
    }, animate: function (a) {
        ...
        void 0 === a && (a = this.lineColorR, 0 === b && (b = this.fillColorsR) &&
                (a = "object" == typeof b ? b[0] : b));
        return a
        ...
        if (!isNaN(b) && !isNaN(c)) {
            ...
            var h = a.values.value, k = this.maxValue, l = this.minValue, m = this.maxBulletSize, n = this.minBulletSize;
            isNaN(k) || (isNaN(h) || (g = (h - l) /
                    (k - l) * (m - n) + n), l == k && (g = m));
            k = g;
            ...
            var r;
            "xy" == d.type && this.valueField && (r = this.pattern,
                    a.pattern && (r = a.pattern));
            f = this.bullet;
            a.bullet && (f = a.bullet);
            var h = this.bulletBorderThickness, l = this.bulletBorderColorR, m = this.bulletBorderAlpha, q = this.bulletAlpha;
            l || (l = n);
            this.useLineColorForBulletBorder && (l = this.lineColorR);
            var u = a.alpha;
            isNaN(u) || (q = u);
            if ("none" != this.bullet || a.bullet)
                p = AmCharts.bullet(e, f, g, n, q, h, l, m, k, 0, r);
            if (this.customBullet || a.customBullet)
                r = this.customBullet, a.customBullet && (r = a.customBullet), r && (p && p.remove(), "function" == typeof r ? (p = new r, p.chart = d, a.bulletConfig && (p.availableSpace =
                        c, p.graph = this, p.graphDataItem = a, p.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(e), p = p.set) : (d.path && (r = d.path + r), p = e.set(), e = e.image(r, 0, 0, g, g), p.push(e), this.centerCustomBullets && e.translate(-g / 2, -g / 2)));
            p && ((a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer"), "serial" == d.type && (0 > b - 0 || b - 0 > this.width || c < -g / 2 || c - 0 > this.height) && (p.remove(), p = null), p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p)), a.bx = b,
                    a.by = c, AmCharts.setCN(d, p, this.bcn + "bullet"), a.className && AmCharts.setCN(d, p, a.className, !0));
        ...
        for (b = 0; b < a.length; b++)
            a[b].graphDataItem.customBullet &&
                    a[b].show()
        ...
        if (a) {
            var c = {type: "rightClickGraphItem", item: a, index: a.index,
...
AmCharts.ChartCursor = AmCharts.Class({construct: function (a) {
        ...
        d || (d = b.valueAxes[0]);
        a.valueLineAxis = d;
        a.valueLineBalloonEnabled && (d = new AmCharts.AmBalloon, a.vaBalloon = d, AmCharts.copyProperties(c, d), d.animationDuration = 0, a.rotate || (d.pointerOrientation =
                "H"));
        ...
        if (a.valueBalloonsEnabled)
            for (c = 0; c < b.graphs.length; c++)
                d = new AmCharts.AmBalloon, d.className = b.graphs[c].id, d.chart = b, AmCharts.copyProperties(b.balloon, d), b.graphs[c].valueBalloon = d;
        ...
        var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = this.categoryBalloon, e, f, g, h;
        g = a.dx;
        h = a.dy;
        var k = this.width, l = this.height, m = a.rotate;
        ...
        this.valueLineEnabled && (e = this.valueLineAlpha,
                isNaN(e) || (b = e), b = AmCharts.line(this.container, g, h, this.cursorColor, b, 1), AmCharts.setCN(a, b, "cursor-value-line"), this.vLine = b, this.set.push(b));
        ...
        if (a.mouseIsOver) {
            ...
            -.5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c), this.setPosition()) : this.rolledOver && (this.handleMouseOut(),
                    this.rolledOver = !1)
        } else
        ...
        if ((c || d) && !this.panning && !this.drawing) {
            c && c.show();
            var e = this.valueLineAxis, f, g = this.rotate;
    ...
    getMousePosition: function () {
        ...
        isNaN(a) || (c > a && (e = a, g = c - a), c < a && (e = c, g = a - c), c == a && (e = a, g = 0), g += this.extraWidth, e -= this.extraWidth /
                2);
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (!d.hidden && d.balloonText) {
                ...
                if (!isNaN(f)) {
                    ...
                    d = AmCharts.circle(a, this.bulletSize / 2, this.chart.getBalloonColor(d,
                            e, !0), d.cursorBulletAlpha);
                    d.translate(h, f);
        ...
        c = this.height;
        a = d.stepWidth;
        this.fullWidth && (f = 1, d.parseDates && !d.equalSpacing && (f = d.minDuration()), e ? this.extraWidth = c = a * f : (this.extraWidth = b = a * f, this.categoryBalloon.minWidth = b), this.line && this.line.remove(), this.line = AmCharts.rect(this.container, b, c, this.cursorColor, this.cursorAlpha, 0), this.fullRectSet &&
                this.fullRectSet.push(this.line));
        this.stepWidth = a;
        ...
        void 0 === b && (b = !0);
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data))
                isNaN(a) && (a = this.getMousePosition()), (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a) && ("mouse" == this.cursorPosition && (this.tempPosition =
                        a), isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition || this.oneBalloonOnly) && (this.updateCursor(c, b), this.zoomed = !1), this.previousMousePosition = a
        } else
    ...
    updateCursor: function (a, b) {
        ...
        if (this.enabled) {
            ...
            var g = c.categoryAxis, h = c.dx, k = c.dy, l = this.x + 1, m = this.y + 1, n = this.width, p = this.height, r = this.data[a];
            this.fireMoved();
            if (r) {
                var q = r.x[g.id], u = c.rotate,
                        z = this.stepWidth, x = this.categoryBalloon, t = this.firstTime, w = this.lastTime, y = this.cursorPosition, A = this.zooming, C = this.panning, B = c.graphs;
                if (c.mouseIsOver || A || C || this.forceShow)
                    if (this.forceShow = !1, C) {
                        var h = this.panClickPos, c = this.panClickEndTime, A = this.panClickStartTime, H = this.panClickEnd, l = this.panClickStart, e = (u ? h - f : h - e) / z;
                        if (!g.parseDates || g.equalSpacing)
                            e = Math.round(e);
                        0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > w && (e = w - c), A + e < t && (e = t - A), h.start =
                                Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : H + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = H + e, this.fire(h.type, h)))
                    } else {
                        ...
                        if (0 < this.cursorAlpha) {
                            var D = this.line;
                            u ? (t =
                                    0, w = q + k, d && (w -= g.cellWidth / 2)) : (t = q, w = 0, d && (t -= g.cellWidth / 2));
                            z = this.animationDuration;
                            0 < z && !this.zooming ? isNaN(this.previousX) ? D.translate(t, w) : (D.translate(this.previousX, this.previousY), D.animate({translate: t + "," + w}, z, "easeOutSine")) : D.translate(t, w);
                            this.previousX = t;
                            this.previousY = w;
                            D.show()
                        }
                        ...
                        z = !0;
                        A && (z = !1);
                        this.categoryBalloonEnabled && z ? (this.setBalloonPosition(x, g, q, u), (t = this.categoryBalloonFunction) ?
                                x.showBalloon(t(r.category)) : g.parseDates ? (g = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat, c), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, r.category)), x.showBalloon(g)) : x.showBalloon(AmCharts.fixNewLines(r.category))) : x.hide();
                        B && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            q = Infinity;
                            for (g = 0; g < B.length; g++)
                                t = B[g], t.showBalloon && !t.hidden && t.balloonText && (w = r.axes[t.valueAxis.id].graphs[t.id], x = w.y, isNaN(x) || (u ? Math.abs(e - x) < q && (q = Math.abs(e - x), H = t) : Math.abs(f -
                            ...
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                ...
                                for (g = 0; g < B.length; g++)
                                    if (t = B[g], x = NaN, (!this.oneBalloonOnly || t == H) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (r = this.data[a + 1]), r)) {
                                        if (w = r.axes[t.valueAxis.id].graphs[t.id])
                                            x =
                                                    w.y;
                                        if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length)
                                            for (q = a + 1; q < this.data.length; q++)
                                                if (d = this.data[q])
                                                    if (w = d.axes[t.valueAxis.id].graphs[t.id], x = w.y, !isNaN(x))
                                                        break;
                                        if (!isNaN(x)) {
                                            d = w.x;
                                            k = !0;
                                            if (u) {
                                                if (q = x, 0 > d || d > p)
                                                    k = !1
                                            } else if (q = d, d = x, 0 > q || q > n + h + 1)
                                                k = !1;
                                            k && (k = this.graphBulletSize, D = this.graphBulletAlpha, 1 == k && isNaN(D) || !AmCharts.isModern || !(y = w.bulletGraphics) || (y.getBBox(), y.translate(w.bx, w.by, k), this.resizedBullets.push(w), isNaN(D) || (y.setAttr("fill-opacity", D), y.setAttr("stroke-opacity",
                                                ...
                                                balloon: k})), !u && k.set && (k.set.hide(), t = k.textDiv) && (t.style.visibility = "hidden"))
                                        }
                                    }
                                this.avoidBalloonOverlapping && this.arrangeBalloons()
                            }
                        b ? (h = {type: "changed"}, h.index = a, h.chart = this.chart, h.zooming = A, h.mostCloseGraph = H, h.position = u ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
        ...
        var d = b.position, e = b.inside, f = b.axisThickness, g = b.tickLength,
                h = this.chart, k = h.dx, h = h.dy, l = this.x, m = this.y, n = this.width, p = this.height;
    ...
    handleMouseDown: function (a) {
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? e : d, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime =
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct: function (a) {
        ...
        if (h) {
            c = h.x + e;
            d = h.y + f;
            var k = h.width, h = h.height, l = this.rotate, m = this.chart, n = this.width, p = this.height, r = m.mouseX, q = m.mouseY;
            a = this.initialMouse;
            this.forceClip && this.clipDragger(!0);
            m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (q - a), 0 > a && (a = 0), m = p - h, a > m && (a = m), g.setAttr("y", a)) : (a = m + (r - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), g.setAttr("x", a)), this.clipDragger(!0)), this.resizingRight && (l ? (a = q - d, a + d > p + f && (a = p - d + f), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = .1), g.setAttr("height",
    ...
    removeCursors: function () {
        ...
        if (!a.resizingRight && !a.resizingLeft) {
            ...
            a.updateOnReleaseOnly ? (a.skipEvent = !1, e.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (c = Math.round(c), l ? e.animate({y: c}, d, ">") : e.animate({x: c}, d, ">"), a.forceClip = !0, clearTimeout(a.forceTO),
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function (a) {
        ...
        if (l = a.graph) {
            ...
            for (r = 0; r < c.length; r++) {
                var q = c[r].axes[p.id].graphs[l.id].values, u;
                for (u in q)
        ...
        if (this.skipEvent)
            ...
            if (h.parseDates && !h.equalSpacing) {
                if (a = g.lastTime, g = g.firstTime, h.minDuration(), h = Math.round(b / k) + g, b = this.dragging ? h + this.timeDifference : Math.round((b + c) / k) + g, h > b && (h = b), 0 < e && b - h < e && (b = Math.round(h + (b - h) / 2), d = Math.round(e / 2), h = b - d, b += d, d = !0), b > a && (b = a), b - e < h && (h = b - e), h < g && (h = g), h + e > b && (b = h + e), h != this.startTime || b != this.endTime)
                    this.startTime = h, this.endTime = b, f.start = h, f.end = b, f.startDate = new Date(h),
                            f.endDate = new Date(b), this.fire(f.type, f)
            } else if (h.startOnAxis || (b += k / 2), c -= this.stepWidth / 2, e = h.xToIndex(b), b = h.xToIndex(b + c), e != this.start || this.end != b)
                h.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, h.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))), this.fire(f.type, f);
...
AmCharts.AmBalloon = AmCharts.Class({construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor, n = this.fillColor, p = this.borderColor, r = n;
                void 0 != m && (this.adjustBorderColor ? r = p = m : n = m);
                var q = this.horizontalPadding, u = this.verticalPadding, z = this.pointerWidth, x = this.pointerOrientation, t = this.cornerRadius, w = c.fontFamily, y = this.fontSize;
                void 0 == y && (y = c.fontSize);
                var m = document.createElement("div"), A = c.classNamePrefix;
                m.className = A + "-balloon-div";
                this.className && (m.className = m.className +
                        " " + A + "-balloon-div-" + this.className);
                A = m.style;
                A.pointerEvents = "none";
                A.position = "absolute";
                var C = this.minWidth, B = "";
                ...
                C < g && (C = g);
                C + B > k && (C = k - B);
                var h = y + u, l = C + q, u = this.shadowAlpha, D = this.shadowColor, q = this.borderThickness, I = this.bulletSize, X;
                0 < t || 0 === z ? (0 < u && (a = AmCharts.rect(e, B, w, n, 0, q + 1, D, u, this.cornerRadius), AmCharts.isModern ?
                        ...
                        f.push(a)), n = AmCharts.polygon(e, r, t, n, this.fillAlpha, q, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: C - e + "," + y},
                b, "easeOutSine"), m && (A.left = this.prevTX + "px", A.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = C - e;
                this.prevY = y;
                this.prevTX = l;
                this.prevTY = h
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
        ...
        if (e) {
            var f = !1, g, h = this.categoryAxis, k, l, m;
            h && (f = h.parseDates, k = h.forceShowField, m = h.classNameField, l = h.labelColorField, g = h.categoryFunction);
            var n, p, r = {}, q;
            f &&
                    (b = AmCharts.extractPeriod(h.minPeriod), n = b.period, p = b.count, q = AmCharts.getPeriodDuration(n, p));
            var u = {};
            this.lookupTable = u;
            var z, x = this.dataDateFormat, t = {};
            for (z = 0; z < e.length; z++) {
                ...
                l && (w.labelColor = y[l]);
                u[y[d]] = w;
                if (f && (b = h.categoryFunction ? h.categoryFunction(b, y, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : x ? AmCharts.stringToDate(b, x) : new Date(b), b = AmCharts.resetDateToMin(b,
                        n, p, h.firstDayOfWeek), w.category = b, w.time = b.getTime(), isNaN(w.time)))
                    continue;
        ...
        a.fillColorsR = a.fillColors ?
                a.fillColors : a.lineColorR;
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
        ...
        !0 === c && (d = 0);
        (c = a.wedge) && (0 < d ? c.animate({translate: b * a.pullX + "," + b * a.pullY}, d, this.pullOutEffect) : c.translate(b *
                a.pullX, b * a.pullY));
        ...
        if (void 0 !== b) {
            ...
            for (e = b = 0; e < c; e++)
                f = a[e], f.percents = f.value / d * 100, f.percents < this.groupPercent && b++;
            1 < b && (this.groupValue = 0, this.removeSmallSlices(), a.push({title: this.groupedTitle, value: this.groupValue, percents: this.groupValue /
                        d * 100, pulled: this.groupedPulled, color: this.groupedColor, url: this.groupedUrl, description: this.groupedDescription, alpha: this.groupedAlpha, pattern: this.groupedPattern, className: this.groupedClassName, dataContext: {}}));
            c = this.baseColor;
            c || (c = this.pieBaseColor);
            d = this.brightnessStep;
            d || (d = this.pieBrightnessStep);
            for (e = 0; e < a.length; e++)
                c ? g = AmCharts.adjustLuminosity(c, e * d / 100) : (g = this.colors[e], void 0 === g && (g = AmCharts.randomColor())), void 0 === a[e].color && (a[e].color = g);
            this.recalculatePercents()
        }
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function (a) {
        ...
        if ("serial" == this.type) {
            ...
            for (b = 0; b < c.length; b++)
                d = c[b], d.ignoreAxisWidth || (d.setOrientation(!1), d.fixAxisPosition(),
                        a[d.position] = !0)
        }
        ...
        for (l = 0; l < a.length; l++)
            b = this.getAxisBounds(a[l], g, k, h, b), g = Math.round(b.l), k = Math.round(b.r), h = Math.round(b.t), b = Math.round(b.b);
        if (a = this.categoryAxis)
            b = this.getAxisBounds(a, g, k, h, b), g = Math.round(b.l),
        ...
        void 0 !== g && (c = AmCharts.text(a.container, g, c, a.fontFamily, d, "start"), AmCharts.setCN(a, c, "zoom-out-label"), d = c.getBBox(), p = n ? n.height / 2 - 3 : d.height /
                2, c.translate(l, p), b.push(c));
        n = b.getBBox();
        c = 1;
        ...
        var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, e = this.plotAreaWidth - 1, f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, h = this.plotAreaFillAlphas,
        ...
        g.translate(c + a, d + b);
        this.set.push(g);
        0 !== a && 0 !== b && (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = AmCharts.adjustLuminosity(g, -.15), e = AmCharts.polygon(this.container, [0, a, e + a, e, 0], [0, b, b, 0, 0], g, h, 1, k, l), AmCharts.setCN(this, e, "plot-area-bottom"),
                e.translate(c, d + f), this.set.push(e), a = AmCharts.polygon(this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0], g, h, 1, k, l), AmCharts.setCN(this, a, "plot-area-left"), a.translate(c, d), this.set.push(a));
    ...
    removeTrendLine: function (a) {
        ...
        if (a) {
            a.rotate = b;
            var c = this.marginTopReal, d = this.marginLeftReal,
                    e = a.scrollbarHeight, f = this.dx, g = this.dy, h = a.offset;
        ...
        AmCharts.AmRectangularChart.base.handleMouseDown.call(this,
                a);
...
AmCharts.TrendLine = AmCharts.Class({construct: function (a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, q = a.initialXValue, u = a.finalXValue, z = a.initialValue, x = a.finalValue,
                t = p.recalculateToPercents, w = b.dataDateFormat;
        ...
        isNaN(d) || isNaN(e) ||
                ...
                b.marginTopReal), b.trendLinesSet.push(c), AmCharts.setCN(b, d, "trend-line"), AmCharts.setCN(b, d, "trend-line-" + a.id), a.line = d, a.set = c, h.mouseup(function () {
            a.handleLineClick()
        }).mouseover(function () {
            a.handleLineOver()
        }).mouseout(function () {
...
AmCharts.line = function (a, b, c, d, e, f, g, h, k, l, m) {
    if (a.handDrawn && !m)
        return AmCharts.handDrawnLine(a, b, c, d, e, f, g, h, k, l, m);
...
AmCharts.makeHD = function (a, b, c) {
    for (var d = [], e = [], f = 1; f < a.length; f++)
        for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, n = 0; n <= m; n++) {
            var p = g + n * k + Math.random() * c, r = h + n * l + Math.random() * c;
            d.push(p);
            e.push(r)
        }
    return[d, e]
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var p = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], q = 1; q < p.length; q++)
            n.push(AmCharts.line(a, [p[q - 1], p[q]], [r[q - 1], r[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    g = p(g);
    h = p(h);
    var r = p(g / f * h), q = AmCharts.VML, u = 359.5 + f / 100;
    359.94 < u && (u = 359.94);
    e >= u && (e = u);
    var z = 1 / 180 * Math.PI, u = b + Math.sin(d * z) * h, x = c - Math.cos(d * z) * r, t = b + Math.sin(d * z) * f, w = c - Math.cos(d * z) * g, y = b + Math.sin((d + e) * z) * f, A = c - Math.cos((d + e) * z) * g, C = b + Math.sin((d + e) * z) * h, z = c - Math.cos((d + e) * z) * r, B = {fill: AmCharts.adjustLuminosity(l.fill, -.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, H = 0;
    180 < Math.abs(e) && (H = 1);
    d = a.set();
    var D;
    ...
    0 < k && (I = " M" + u + "," + (x + k) + " L" + t + "," + (w + k), q ? (D || (I += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (w + k) + "," + y + "," + (A + k)), I += " L" + C + "," + (z + k), 0 < h && (D || (I += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) +
            "," + C + "," + (k + z) + "," + u + "," + (k + x)))) : (I += " A" + f + "," + g + ",0," + H + ",1," + y + "," + (A + k) + " L" + C + "," + (z + k), 0 < h && (I += " A" + h + "," + r + ",0," + H + ",0," + u + "," + (x + k))), I = a.path(I + " Z", void 0, void 0, "1000,1000").attr(B), d.push(I), I = a.path(" M" + u + "," + x + " L" + u + "," + (x + k) + " L" + t + "," + (w + k) + " L" + t + "," + w + " L" + u + "," + x + " Z", void 0, void 0, "1000,1000").attr(B), k = a.path(" M" + y + "," + A + " L" + y + "," + (A + k) + " L" + C + "," + (z + k) + " L" + C + "," + z + " L" + y + "," + A + " Z", void 0, void 0, "1000,1000").attr(B), d.push(I), d.push(k));
    q ? (D || (e = " A" + p(b - f) + "," + p(c - g) +
            "," + p(b + f) + "," + p(c + g) + "," + p(t) + "," + p(w) + "," + p(y) + "," + p(A)), f = " M" + p(u) + "," + p(x) + " L" + p(t) + "," + p(w) + e + " L" + p(C) + "," + p(z)) : f = " M" + u + "," + x + " L" + t + "," + w + (" A" + f + "," + g + ",0," + H + ",1," + y + "," + A) + " L" + C + "," + z;
    ...
    if (m) {
        ...
        for (c = 0; c < m.length; c++)
            b.push(AmCharts.adjustLuminosity(l.fill, m[c]));
...
AmCharts.Bezier = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l) {
        ...
        e = [];
        for (k = 0; k < b.length; k++)
            e.push({x: Number(b[k]), y: Number(c[k])});
...
AmCharts.AmDraw = AmCharts.Class({construct: function (a, b, c, d) {
        ...
        if (AmCharts.hasSVG) {
            ...
            AmCharts.isIE && AmCharts.VMLRenderer && (AmCharts.VML = !0, AmCharts.vmlStyleSheet || (document.namespaces.add("amvml", "urn:schemas-microsoft-com:vml"), 31 > document.styleSheets.length ?
...
AmCharts.VMLRenderer = AmCharts.Class({construct: function (a, b) {
        ...
        if ("group" == b)
            ...
            c = document.createElement("img"), a.type =
                    "image";
        else {
            a.type = "shape";
        ...
        for (e = 0; e < b.length; e++) {
            ...
            "Z" == g && (a += " x e");
            if ("Q" == g) {
                var l = c.length, m = c[l - 1], n = h[0], p = h[1], k = h[2], r = h[3];
                c = d(c[l - 2] / 3 + 2 / 3 * n);
                m = d(m / 3 + 2 / 3 * p);
                n = d(2 / 3 * n + k / 3);
                p = d(2 / 3 * p + r / 3);
...
AmCharts.AmLegend = AmCharts.Class({construct: function (a) {
        ...
        this.titleWidth = 0;
        if (e = this.title)
            e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, e, "legend-title"), e.translate(this.marginLeft,
                    this.marginTop + this.verticalGap + this.ly + 1), a = e.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns,
                l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, r = 0, q = this.container;
        this.set && this.set.remove();
        var u = q.set();
        this.set = u;
        var z = q.set();
        u.push(z);
        var x = this.entries, t, w;
        ...
        for (w = 0; w < x.length; w++) {
            ...
            D + t.width > n && 0 < w && 0 !== y && (r++, y = 0,
                    D = f, A = D + t.width + f + m, C = C + B + l, B = 0);
            H.translate(D, C);
            y++;
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                    g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-line"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m = AmCharts.bullet(k, a.bullet,
                            a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), p = 0, m = l, n = l / 3;
                else {
                    var r;
                    a.getGradRotation && (r = a.getGradRotation());
                    m = a.fillColorsR;
                    !0 === a.hidden && (m = d);
                    if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, r, g))
                        p = l, g.translate(p, l / 2);
                    m = l
                }
                AmCharts.setCN(b, g, "graph-" + c);
                AmCharts.setCN(b, g, "graph-" + a.id)
            } else
                h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c,
                        d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
            ...
            (f = this.switchType) && "none" != f && ("x" == f ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == f ? c.hide() : c.show() : "x" != f && c.hide(), this.switchable || c.hide(), this.addListeners(c, a), a.legendSwitch =
                    c, k.push(c), AmCharts.setCN(b, c, "legend-switch"));
            f = this.color;
            ...
            var q;
            d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, q = this.labelWidth, q = isNaN(q) ? AmCharts.text(this.container,
                    d, f, b.fontFamily, c, "start") : AmCharts.wrappedText(this.container, d, f, b.fontFamily, c, "start", !1, q, 0), AmCharts.setCN(b, q, "legend-label"), q.translate(this.lx + m, this.ly), k.push(q), b = q.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
        ...
        var b = this, c = b.fontSize, d = b.chart;
        if (!1 !== a.visibleInLegend) {
            ...
            if (b.valueText && 0 < b.valueWidth) {
                ...
                var h = b.valueText, e = e + b.lx +
                        b.markerLabelGap + b.valueWidth, k = "end";
            ...
            c = b.container.rect(a.legendEntryWidth, 0, f, d, 0, 0).attr({stroke: "none", fill: "#fff", "fill-opacity": .005});
            c.dItem = a;
...
AmCharts.stringToDate = function (a, b) {
    ...
    for (k = 0; k < d.length; k++)
        h = d[k].period, c[h] = 0, "date" == h && (c[h] = 1);
    for (k = 0; k < d.length; k++)
...
AmCharts.getFromDateString = function (a, b, c) {
    if (void 0 !== b)
        return c = c.indexOf(a), b = b.substr(c, a.length), "0" == b.charAt(0) && (b = b.substr(1, b.length - 1)), b = Number(b), isNaN(b) && (b = 0), -1 != a.indexOf("M") && b--, b
};
...
AmCharts.changeDate = function (a, b, c, d, e) {
    if (AmCharts.useUTC)
        return AmCharts.changeUTCDate(a, b, c, d, e);
    var f = -1;
    void 0 === d && (d = !0);
    void 0 === e && (e = !1);
    !0 === d && (f = 1);
